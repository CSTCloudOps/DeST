...
from models.unified_representation.representation import SLD,ADSLD
...
def AD(time_model, train_samples, test_samples, ad_cases_label, split_ratio=0.6, method='num', t_value=3, q=0.1, level=0.95, delay=600, impact_window=300, verbose=False):
    ...
    init_slds = ADSLD(time_model, init_samples, method, t_value)
    eval_slds = ADSLD(time_model, eval_samples, method, t_value)
    # print("print ok \n")
    # time.sleep()
